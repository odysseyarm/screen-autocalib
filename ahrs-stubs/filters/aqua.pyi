...
import numpy
import numpy as np
__all__ = ['AQUA', 'GRAVITY', 'MUNICH_HEIGHT', 'MUNICH_LATITUDE', 'WGS', 'adaptive_gain', 'np', 'q2R', 'q_prod', 'slerp_I']
class AQUA:
    """
    ...
    """
    def Omega(self, x: numpy.ndarray) -> numpy.ndarray:
        """
        Omega operator.
        ...
        """
    def __init__(self, gyr: numpy.ndarray = None, acc: numpy.ndarray = None, mag: numpy.ndarray = None, **kw):
        ...
    ...
    def estimate(self, acc: numpy.ndarray, mag: numpy.ndarray = None) -> numpy.ndarray:
        ...
        """
    def init_q(self, acc: numpy.ndarray, mag: numpy.ndarray = None) -> numpy.ndarray:
        ...
    def updateIMU(self, q: numpy.ndarray, gyr: numpy.ndarray, acc: numpy.ndarray) -> numpy.ndarray:
        """
        ...
        """
    def updateMARG(self, q: numpy.ndarray, gyr: numpy.ndarray, acc: numpy.ndarray, mag: numpy.ndarray) -> numpy.ndarray:
        """
        ...
        """
def adaptive_gain(gain: float, a_local: numpy.ndarray, t1: float = 0.1, t2: float = 0.2, g: float = ...) -> float:
    """
    ...
    """
def slerp_I(q: numpy.ndarray, ratio: float, t: float) -> numpy.ndarray:
    """
