...
import numpy
import numpy as np
__all__ = ['Mahony', 'acc2q', 'am2q', 'np', 'q2R', 'q_conj', 'q_prod']
class Mahony:
    """
    ...
    """
    def __init__(self, gyr: numpy.ndarray = None, acc: numpy.ndarray = None, mag: numpy.ndarray = None, frequency: float = 100.0, k_P: float = 1.0, k_I: float = 0.3, q0: numpy.ndarray = None, **kwargs):
        ...
