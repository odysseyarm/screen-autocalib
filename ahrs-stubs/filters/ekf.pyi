...
import numpy
import numpy as np
__all__ = ['EKF', 'acc2q', 'cosd', 'ecompass', 'np', 'q2R', 'sind', 'skew']
class EKF:
    """
    ...
    def Omega(self, x: numpy.ndarray) -> numpy.ndarray:
        ...
        """
    def __init__(self, gyr: numpy.ndarray = None, acc: numpy.ndarray = None, mag: numpy.ndarray = None, frequency: float = 100.0, frame: str = 'NED', **kwargs):
        ...
    def _compute_all(self, frame: str) -> numpy.ndarray:
        """
        ...
        """
    def _set_measurement_noise_covariance(self, **kw) -> numpy.ndarray:
        ...
    def _set_reference_frames(self, mref: float, frame: str = 'NED') -> None:
        ...
    def dfdq(self, omega: numpy.ndarray) -> numpy.ndarray:
        """
        ...
        """
    def dhdq(self, q: numpy.ndarray, mode: str = 'normal') -> numpy.ndarray:
        """
        ...
        """
    def f(self, q: numpy.ndarray, omega: numpy.ndarray) -> numpy.ndarray:
        """
        ...
        """
    def h(self, q: numpy.ndarray) -> numpy.ndarray:
        """
        Measurement Model
