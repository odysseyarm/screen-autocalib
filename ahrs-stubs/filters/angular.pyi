...
class AngularRate:
    ...
    """
    def __init__(self, gyr: numpy.ndarray = None, q0: numpy.ndarray = None, frequency: float = 100.0, order: int = 1, **kw):
        ...
    def _compute_all(self):
        """
        Estimate all quaternions with given sensor values
        """
    def update(self, q: numpy.ndarray, gyr: numpy.ndarray, method: str = 'closed', order: int = 1) -> numpy.ndarray:
        """
